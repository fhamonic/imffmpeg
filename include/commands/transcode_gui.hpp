    ...
    std::string make_command() const {
        ...
        for(auto && stream : file_properties["streams"]) {
            ...
            if(custom_default_audio_lang &&
               ...
               custom_accepted_audio_langs &&
               !contains(accepted_audio_langs,
...
public:
    ...
    bool custom_accepted_audio_langs = false;
    char accepted_audio_langs_buffer[64] = "eng,fra";
    ...
    void showAudioHeader() {
        if(ImGui::CollapsingHeader("Audio")) {
            ...
            ImGui::Text("Accepted lang.:");
            ImGui::SameLine();
            ImGui::Checkbox("##custom_accepted_audio_langs",
                            &custom_accepted_audio_langs);
            ImGui::SameLine();
            ImGui::InputText("##accepted_audio_langs",
                             accepted_audio_langs_buffer, 64);
